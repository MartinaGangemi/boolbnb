                ...
                <div class="card card-index">
                    ...
                    <div class="card-body">
                        ...
                        <div class="options text-center">
                            <!-- view -->
                            <a class="btn btn-primary text-white" href="{{route('admin.apartments.show',$apartment->slug)}}">
                            ...
                            <!-- edit -->
                            <a class="btn btn-secondary text-white" href="{{route('admin.apartments.edit',$apartment->slug)}}">
                            ...
                            <!-- delete -->
                            <button type="button" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#delete-apartment-{{$apartment->id}}">
